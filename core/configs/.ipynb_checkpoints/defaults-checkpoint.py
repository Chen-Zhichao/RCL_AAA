...
_C.INPUT.PIXEL_MEAN = [0.485, 0.456, 0.406]     # pixel mean of IMAGENET
_C.INPUT.PIXEL_STD = [0.229, 0.224, 0.225]      # pixel std of IMAGENET
...
_C.STYLE_DATASETS = CN()
_C.STYLE_DATASETS.IS_OVERALL_STYLE_COMPUTED = False
_C.STYLE_DATASETS.IS_CLASS_STYLE_COMPUTED = False

_C.SOLVER = CN()
_C.SOLVER.WARMUP_ITER = 10000
