...
def test(cfg):
    logger = logging.getLogger("RCL-AAA.tester")
    ...
    for batch in tqdm(test_loader, position=0, mininterval=10):
...
def main():
    parser = argparse.ArgumentParser(description="Regional Contrastive Loss & Adaptive Active Annotation")
    ...
    save_dir = ""
    logger = setup_logger("RCL-AAA", save_dir, 0)
    logger.info(cfg)
